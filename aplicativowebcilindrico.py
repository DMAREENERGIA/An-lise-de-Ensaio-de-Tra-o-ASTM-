...
# Garantir instalação da biblioteca FPDF2 para geração de PDF
try:
...
def gerar_pdf_relatorio(resultados, d0, L0, df, Lf, fig):
    ...
    # Salvar o gráfico temporariamente para inserir no PDF
...
if processar and dados_input:
    ...
    if len(dados_ensaio) > 0:
        ...
        # --- GERAR E EXPORTAR O RELATÓRIO PDF ---
        st.divider()
        ...
        st.download_button(
            ...
            data=pdf_bytes,
            file_name=f"Relatorio_Ensaio_Tracao_Cilindrico.pdf",
